...
export async function POST(request: NextRequest) {
    try {
        ...
        const transporter = nodemailer.createTransport({
            service: "gmail",
            auth: {
                user: "19.yudee@gmail.com", // Your Gmail address
                pass: "dhti pneo wbgc untv", // Your Gmail app password
            },
        });

        // Email content for admin notification
        const adminMailOptions = {
            from: "19.yudee@gmail.com",
            to: "sloppyman51@gmail.com", // Admin email
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                    ...
                    <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e2e8f0; font-size: 12px; color: #718096;">
                        <p>This email was sent from the contact form on your Company Name website.</p>
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                    <div style="background-color: #2D3748; color: white; padding: 20px; text-align: center;">
                        <h1 style="margin: 0; font-size: 24px; letter-spacing: 2px;">Company Name</h1>
                    </div>
